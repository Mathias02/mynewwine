...
const Catalog = ({list}) => {
  ...
  return (
    <div>
        <Link href={`/category/${list.attributes?.Name}`} className='p-2 text-center border rounded-lg hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer'>
