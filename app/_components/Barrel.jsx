  ...
  return (
    <div className='grid md:grid-cols-2 gap-3 mt-8'>
      ...
      <div className='flex items-start justify-start flex-col gap-3 lg:text-xl px-5 py-9 text-gray-500'>
        ...
        <p className='tracking-wide'>Without having tasted the wines, one does not know if, for example, a white is heavy or light. Before taking a sip, the taster tries to determine the 
